...
loghandler = {
    notparam: {
        ...
        getApikey: 'Apikey? Download File Berisi Apikey Nya Dulu Kak :  https://sfile.mobi/3wA1FI0PzaF  , Note : File TIDAK Berisikan VIRUS SAMA SEKALI!'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Apikey? Download File Berisi Apikey Nya Dulu Kak :  https://sfile.mobi/3wA1FI0PzaF  , Note : File TIDAK Berisikan VIRUS SAMA SEKALI!'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
const listkey = ["OrenKeyyy'", "orenkeyyy"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'OrenKeyyy') return res.sendFile(__path + '/views/eror.html')
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'OrenKeyyy')  return res.sendFile(__path + '/views/eror.html')
...
router.get('/darkjokes', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'OrenKeyyy')  return res.json(invalidKeynya)
